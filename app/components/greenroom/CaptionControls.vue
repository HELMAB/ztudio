<script setup>
import { FIT_OPTIONS, POSITION_OPTIONS, PRESET_OPTIONS, WEIGHT_OPTIONS } from '@/lib/greenroom/config'
...
<template>
  <div class="grid grid-cols-2 gap-4">
    ...
    <GreenroomFileInput label="Upload font (.ttf/.otf)" accept=".ttf,.otf,font/ttf,font/otf" @select="onFont" />
