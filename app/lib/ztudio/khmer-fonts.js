...
const FONTS = [
  ...
  {
    family: 'AKbalthom KhmerLight',
    label: 'AKbalthom Khmer Light',
    file: 'akbalthom-khmerlight.ttf',
  },
  { family: 'AKbalthom KhmerNew', label: 'AKbalthom Khmer New', file: 'akbalthom-khmernew.ttf' },
  {
    family: 'Carlsberg Sans Light',
    label: 'Carlsberg Sans Light',
    file: 'carlsbergsans-light.ttf',
  },
  { family: 'Carlsberg Sans Bold', label: 'Carlsberg Sans Bold', file: 'carlsbergsans-bold.ttf' },
  {
    family: 'Carlsberg Sans Black',
    label: 'Carlsberg Sans Black',
    file: 'carlsbergsans-black.ttf',
  },
